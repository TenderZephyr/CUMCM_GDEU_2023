...
inputFile1 = 'D:\\桌面\\CUMCM\\topic\\附件1.xlsx'
df1 = pd.read_excel(inputFile1)

# 读取第二个Excel文件，包含单品编码和其他信息
inputFile2 = 'D:\\桌面\\CUMCM\\topic\\附件2.xlsx'
...
# 指定存放结果的文件夹路径
output_folder = 'D:\\桌面\\CUMCM\\classificationFile_kinds\\all'
...
for category in categories:
    ...
    # 创建一个新的Excel写入对象
    writer = pd.ExcelWriter(os.path.join(output_folder, f'{category}all.xlsx'), engine='xlsxwriter')
