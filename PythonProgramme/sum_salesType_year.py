...
file1_path = 'D:\\桌面\\CUMCM\\topic\\附件1.xlsx'
file2_path = 'D:\\桌面\\CUMCM\\topic\\附件2.xlsx'
output_folder = 'D:\\桌面\\CUMCM\\classificationFile_sales\\sumSales_year'
...
for category_name, category_data in result_df.groupby('分类名称'):
    category_output_file = os.path.join(output_folder, f'{category_name}_sales.xlsx')
