...
LastEditTime: 2023-09-10 13:31
Description: 将附件3拆成每类每日平均进价
'''
import pandas as pd
import os

# 指定输入文件夹路径（六个Excel文件所在的文件夹）
input_folder = 'CUMCM\\classify_cost'  # 替换为实际的输入文件夹路径

# 指定输出文件夹路径
output_folder = 'CUMCM\\classify_cost\\average_cost_day'  # 替换为实际的输出文件夹路径
