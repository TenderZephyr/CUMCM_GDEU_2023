...
# 指定包含Excel文件的文件夹路径
folder_path = "D:\\桌面\\CUMCM\\classificationFile_sales\\sumsales_month"
...
plt.savefig(f'D:\桌面\CUMCM\classificationFile_sales\sumSales_day_plot\\monthSalesPlot_all.png')
